...
DEFAULT_PROMPTS: dict[str, dict[str, str]] = {
    ...
    "generate_microsite": {
        ...
        "user": (
            ...
            "Include a hero with the 5-line narrative hook verbatim, 3 stats, 3-4 editorial sections, role-specific narrative sections for CIO/CFO/Champion, a CTA, and a footer.\n"
            "IMPORTANT: Role-specific narrative sections MUST use in-page anchor links. "
            "Add a role navigation bar with links to #cio-priorities, #cfo-priorities, #champion-priorities. "
            "Each role section MUST have the matching id attribute (id=\"cio-priorities\", id=\"cfo-priorities\", id=\"champion-priorities\"). "
            "Do NOT link role pages to external URLs or the base URL — they are sections within THIS page.\n"
            "These sections are customer-facing and sendable. They should read like tailored role narratives, likely priorities, and outcome framing. "
            "Do NOT present them as questionnaires, discovery checklists, or a list of questions to ask.\n"
            ...
            "Also create customer-facing role-specific narrative content for CIO, CFO, and Champion stakeholders inside the structured output. "
            "Avoid question-led copy unless a single CTA line explicitly benefits from it. "
...
def generate_microsite_node(state: CouncilState) -> CouncilState:
    ...
    user_struct = (
        ...
        "role_pages must contain tailored customer-facing sections for CIO, CFO, and Champion stakeholders within the SAME microsite. "
        "They should read like confident narrative summaries of likely priorities, risks, outcomes, and operating concerns for each role. "
        "They are not internal discovery questionnaires, and they should not be written as lists of questions. "
